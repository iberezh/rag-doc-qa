  ...
  return (
    <section id="pricing" className="relative z-[2] mx-auto max-w-6xl px-6 py-20">
      ...
      <div className="mt-12 grid gap-5 md:grid-cols-3">
        {PLANS.map((plan, idx) => (
          <div key={plan.name} data-reveal="up" data-reveal-delay={idx + 1}>
            <div
              className={cn(
                'group flex h-full cursor-pointer flex-col rounded-xl border bg-card p-6 transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl',
                plan.featured
                  ? 'border-primary shadow-lg hover:shadow-primary/40'
      ...
      <p
        data-reveal="up"
        className="mt-6 text-center font-mono text-[11px] text-muted-foreground"
      >
